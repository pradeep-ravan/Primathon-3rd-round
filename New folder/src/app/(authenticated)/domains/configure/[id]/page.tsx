...
interface DomainConfigurePageProps {
  params: {
    id: string;
  };
}

export default function DomainConfigurePage({
  params,
}: DomainConfigurePageProps) {
  const { data: domain, isLoading, error, refetch } = useDomain(params.id);
